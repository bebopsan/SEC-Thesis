...
\hline 
\end{tabular} 
\caption{Comparison of normalized eigenvalues $\frac{\omega a}{2\pi c}$ for TM fields in square shaped waveguide. Where $a=1$ and $c=1$.}
\end{center}
